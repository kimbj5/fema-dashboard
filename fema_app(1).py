...
@st.cache_data
def load_data():
    url = "https://drive.google.com/uc?export=download&id=1x8eId1u74uaMMO5KZijVmz6tpLC-xgei"
    df = pd.read_csv(url)
    return df
...
st.markdown("**Insight:** TSA-eligible households show higher median repair amounts compared to non-eligible households. A two-sample t-test confirmed this difference is statistically significant (t = 43.879, p < 0.001), suggesting that TSA eligibility is associated with greater damage costs.")
